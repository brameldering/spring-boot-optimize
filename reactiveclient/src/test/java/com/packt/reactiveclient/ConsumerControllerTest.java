package com.packt.reactiveclient;
...
import com.packt.reactiveclient.controllers.ConsumerController;
import com.packt.reactiveclient.records.Card;

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = {ReactiveclientApplication.class, ConsumerController.class, ConsumerControllerTest.Config.class})
